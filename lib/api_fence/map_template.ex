defmodule ApiFence.MapTemplate do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    quote do
      import ApiFence.MapTemplate
      require ApiFence.MapTemplate
    end
  end
...
defimpl Inspect, for: ApiFence.MapTemplate do
