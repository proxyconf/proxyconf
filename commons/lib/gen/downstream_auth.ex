defmodule ProxyConf.Commons.Gen.DownstreamAuth do
  @moduledoc """
  ...
  @external_resource Path.join(__DIR__, "../../lua/vendor/md5/md5.lua")
  @lua_includes Enum.reduce([Path.join(__DIR__, "../../lua/vendor/md5/md5.lua")], [], fn f,
                                                                                         code ->
  ...
  @downstream_lua Path.join(__DIR__, "downstream_auth.lua")
  @external_resource @downstream_lua
  @lua_prelude [
    "package.path=\"\"\n\n",
    @lua_includes,
    File.read!(@downstream_lua)
  ]
